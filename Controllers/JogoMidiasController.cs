...
namespace DevSteamAPI.Controllers
{
    ...
    public class JogoMidiasController : ControllerBase
    {
        ...
        // GET: api/JogoMidias
        [HttpGet]
        public async Task<ActionResult<IEnumerable<JogoMidia>>> GetjogoMidias()
        {
            return await _context.jogoMidias.ToListAsync();
        }
        ...
        {
            var jogoMidia = await _context.jogoMidias.FindAsync(id);
        ...
        {
            _context.jogoMidias.Add(jogoMidia);
            await _context.SaveChangesAsync();
        ...
        public async Task<IActionResult> DeleteJogoMidia(Guid id)
        {
            ...
            _context.jogoMidias.Remove(jogoMidia);
            await _context.SaveChangesAsync();
        ...
        {
            return _context.jogoMidias.Any(e => e.JogoMidiaId == id);
        }
    }
}
